...
exports.Liveboard = undefined;

var _liveboard = __webpack_require__(130);
...
var _reactMoment = __webpack_require__(150);
...
var Liveboard = function (_Component) {
    _inherits(Liveboard, _Component);

    function Liveboard(props) {
        _classCallCheck(this, Liveboard);

        var _this = _possibleConstructorReturn(this, (Liveboard.__proto__ || Object.getPrototypeOf(Liveboard)).call(this, props));

        _this.state = { departures: [], stationName: props.station };

        _this.fetchInfo = _this.fetchInfo.bind(_this);
        _this.onInfo = _this.onInfo.bind(_this);
        return _this;
    }

    _createClass(Liveboard, [{
        ...
        value: function fetchInfo() {
            _axios2.default.get("https://api.irail.be/liveboard/", {
                params: {
                    format: "json",
        ...
        value: function render() {
            ...
            var rows = this.state.departures.slice(0, this.props.max || this.state.departures.length).map(function (i, j) {
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        i.canceled > 0 ? '' + messages[_this2.props.lang].canceled : ""
                    ),
                    _react2.default.createElement(
                        'td',
                        { className: 'vehicle' },
...
if(false) {
	module.hot.accept("!!../../node_modules/css-loader/index.js!./liveboard.css", function() {
		var newContent = require("!!../../node_modules/css-loader/index.js!./liveboard.css");
...
// module
exports.push([module.i, ".platform {\n    background-color: gray;\n    border-radius: 5px;\n    color: white;\n    width: 1.5vw;\n    height: 1.5vw;\n    text-align: center;\n}\n\n.delay {\n    color: red;\n    font-weight: bold;\n}", ""]);
